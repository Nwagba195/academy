...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-white px-[204px] shadow">
      {({ open }) => (
        <>
          <div className="py-12  sm:px-4 lg:px-8">
              ...
              <div className="flex px-2 lg:px-0">
                <div className="flex flex-shrink-0 gap-4 items-center">
                  <img
                    ...
                    alt="Your Company"
                  />
                  <span className="font-rubik text-[32px] font-black">
                    ACADEMY
                  </span>
                </div>
          ...
          <Disclosure.Panel className="lg:hidden">
            ...
            <div className="border-t border-gray-200 pb-3 pt-4">
              <div className="flex items-center px-4">
                ...
                <button
                  type="button"
                  className="relative ml-auto flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2"
                >
                  <span className="absolute -inset-1.5" />
                  <span className="sr-only">View notifications</span>
